...
public abstract class AbstractProfileIndexWriter extends HtmlDocletWriter {
   ...
   */
  public AbstractProfileIndexWriter(ConfigurationImpl configuration, DocPath filename)
      throws IOException {
   ...
   */
  protected abstract void addProfilesList(
   ...
   */
  protected abstract void addProfilePackagesList(
   ...
   */
  protected void buildProfilePackagesIndexFile(
      String title, boolean includeScript, String profileName) throws IOException {
    String windowOverview = configuration.getText(title);
    Content body = getBody(includeScript, getWindowTitle(windowOverview));
    addNavigationBarHeader(body);
    addOverviewHeader(body);
   ...
   */
  protected void addIndexContents(
      Profiles profiles, String text, String tableSummary, Content body) {

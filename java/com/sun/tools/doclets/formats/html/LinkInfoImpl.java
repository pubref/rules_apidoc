...
public class LinkInfoImpl extends LinkInfo {
   ...
   */
  public LinkInfoImpl(
      ConfigurationImpl configuration, Kind context, ExecutableMemberDoc executableMemberDoc) {
   ...
   */
  public LinkInfoImpl(ConfigurationImpl configuration, Kind context, ClassDoc classDoc) {
    this.configuration = configuration;
   ...
   */
  public LinkInfoImpl(ConfigurationImpl configuration, Kind context, Type type) {
    this.configuration = configuration;
    this.type = type;
    setContext(context);
  }

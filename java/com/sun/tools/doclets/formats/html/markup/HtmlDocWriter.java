...
public abstract class HtmlDocWriter extends HtmlWriter {
  ...
  public Content getHyperLink(
      DocPath link, Content label, boolean strong, String stylename, String title, String target) {
    return getHyperLink(new DocLink(link), label, strong, stylename, title, target);
  }
  ...
  public void printFramesetDocument(String title, boolean noTimeStamp, Content frameset)
    ...
    Content htmlTree = HtmlTree.HTML(configuration.getLocale().getLanguage(), head, frameset);

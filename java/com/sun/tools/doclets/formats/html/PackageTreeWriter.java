...
public class PackageTreeWriter extends AbstractTreeWriter {
  ...
  public PackageTreeWriter(
    ...
    super(
        configuration,
        path,
        new ClassTree(configuration.classDocCatalog.allClasses(packagedoc), configuration));
  ...
  public static void generate(
    ...
    try {
      packgen = new PackageTreeWriter(configuration, path, pkg, prev, next);
  ...
  protected void generatePackageTreeFile() throws IOException {
    ...
    Content headContent =
        getResource("doclet.Hierarchy_For_Package", Util.getPackageName(packagedoc));
    Content heading =
        HtmlTree.HEADING(HtmlConstants.TITLE_HEADING, false, HtmlStyle.title, headContent);
  ...
  protected Content getPackageTreeHeader() {
    String title = packagedoc.name() + " " + configuration.getText("doclet.Window_Class_Hierarchy");
  ...
  protected void addLinkToMainTree(Content div) {
    Content span =
        HtmlTree.SPAN(HtmlStyle.packageHierarchyLabel, getResource("doclet.Package_Hierarchies"));
    div.addContent(span);

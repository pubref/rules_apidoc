...
public abstract class SubWriterHolderWriter extends HtmlDocletWriter {
   ...
   */
  public void addSummaryHeader(AbstractMemberWriter mw, ClassDoc cd, Content memberTree) {
  ...
  public Content getSummaryTableTree(
      AbstractMemberWriter mw, ClassDoc cd, List<Content> tableContents, boolean showTabs) {
    Content caption;
    if (showTabs) {
    ...
    Content table = HtmlTree.TABLE(HtmlStyle.memberSummary, 0, 3, 0, mw.getTableSummary(), caption);
  ...
  public void addInheritedSummaryHeader(
      AbstractMemberWriter mw, ClassDoc cd, Content inheritedTree) {
   ...
   */
  protected void addIndexComment(Doc member, Tag[] firstSentenceTags, Content tdSummary) {
   ...
   */
  public void addSummaryType(
      AbstractMemberWriter mw, ProgramElementDoc member, Content tdSummaryType) {
   ...
   */
  public void addSummaryLinkComment(
      AbstractMemberWriter mw, ProgramElementDoc member, Content contentTree) {

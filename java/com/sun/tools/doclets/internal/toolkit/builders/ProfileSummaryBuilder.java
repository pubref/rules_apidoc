...
public class ProfileSummaryBuilder extends AbstractBuilder {
  ...
  private ProfileSummaryBuilder(
      Context context, Profile profile, ProfileSummaryWriter profileWriter) {
    super(context);
   ...
   */
  public static ProfileSummaryBuilder getInstance(
      Context context, Profile profile, ProfileSummaryWriter profileWriter) {
  ...
  public void buildPackageSummary(XMLNode node, Content summaryContentTree) {
    ...
    for (int i = 0; i < packages.length; i++) {
      ...
      summaryContentTree.addContent(profileWriter.getPackageSummaryTree(packageSummaryContentTree));
    }
  }

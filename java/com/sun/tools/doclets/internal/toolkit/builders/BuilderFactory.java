...
public class BuilderFactory {
  ...
  public BuilderFactory(Configuration configuration) {
    ...
    context =
        new AbstractBuilder.Context(
            configuration, containingPackagesSeen, LayoutParser.getInstance(configuration));
  }
  ...
  public AbstractBuilder getConstantsSummaryBuider() throws Exception {
    return ConstantsSummaryBuilder.getInstance(context, writerFactory.getConstantsSummaryWriter());
  }
   ...
   * @return the builder that builds the constant summary.
   */
  public AbstractBuilder getPackageSummaryBuilder(
      PackageDoc pkg, PackageDoc prevPkg, PackageDoc nextPkg) throws Exception {
    return PackageSummaryBuilder.getInstance(
        context, pkg, writerFactory.getPackageSummaryWriter(pkg, prevPkg, nextPkg));
  }
   ...
   * @return the builder that builds the profile summary.
   */
  public AbstractBuilder getProfileSummaryBuilder(
      Profile profile, Profile prevProfile, Profile nextProfile) throws Exception {
    return ProfileSummaryBuilder.getInstance(
        context, profile, writerFactory.getProfileSummaryWriter(profile, prevProfile, nextProfile));
  }
   ...
   * @return the builder that builds the profile package summary.
   */
  public AbstractBuilder getProfilePackageSummaryBuilder(
      PackageDoc pkg, PackageDoc prevPkg, PackageDoc nextPkg, Profile profile) throws Exception {
    return ProfilePackageSummaryBuilder.getInstance(
        context,
        pkg,
        writerFactory.getProfilePackageSummaryWriter(pkg, prevPkg, nextPkg, profile),
        profile);
  }
   ...
   */
  public AbstractBuilder getClassBuilder(
      ClassDoc classDoc, ClassDoc prevClass, ClassDoc nextClass, ClassTree classTree)
      throws Exception {
    return ClassBuilder.getInstance(
        context, classDoc, writerFactory.getClassWriter(classDoc, prevClass, nextClass, classTree));
  }
  ...
  public AbstractBuilder getAnnotationTypeBuilder(
      AnnotationTypeDoc annotationType, Type prevType, Type nextType) throws Exception {
    return AnnotationTypeBuilder.getInstance(
        context,
        annotationType,
  ...
  public AbstractBuilder getMethodBuilder(ClassWriter classWriter) throws Exception {
    return MethodBuilder.getInstance(
        context, classWriter.getClassDoc(), writerFactory.getMethodWriter(classWriter));
  }
   ...
   *         annotation type.
   */
  public AbstractBuilder getAnnotationTypeFieldsBuilder(AnnotationTypeWriter annotationTypeWriter)
      throws Exception {
    return AnnotationTypeFieldBuilder.getInstance(
        context,
  ...
  public AbstractBuilder getAnnotationTypeOptionalMemberBuilder(
    ...
    return AnnotationTypeOptionalMemberBuilder.getInstance(
        context,
        annotationTypeWriter.getAnnotationTypeDoc(),
  ...
  public AbstractBuilder getAnnotationTypeRequiredMemberBuilder(
      AnnotationTypeWriter annotationTypeWriter) throws Exception {
    return AnnotationTypeRequiredMemberBuilder.getInstance(
        context,
        annotationTypeWriter.getAnnotationTypeDoc(),
  ...
  public AbstractBuilder getEnumConstantsBuilder(ClassWriter classWriter) throws Exception {
    return EnumConstantBuilder.getInstance(
        context, classWriter.getClassDoc(), writerFactory.getEnumConstantWriter(classWriter));
  }
  ...
  public AbstractBuilder getFieldBuilder(ClassWriter classWriter) throws Exception {
    return FieldBuilder.getInstance(
        context, classWriter.getClassDoc(), writerFactory.getFieldWriter(classWriter));
  }
  ...
  public AbstractBuilder getPropertyBuilder(ClassWriter classWriter) throws Exception {
    final PropertyWriter propertyWriter = writerFactory.getPropertyWriter(classWriter);
    return PropertyBuilder.getInstance(context, classWriter.getClassDoc(), propertyWriter);
  }
  ...
  public AbstractBuilder getConstructorBuilder(ClassWriter classWriter) throws Exception {
    return ConstructorBuilder.getInstance(
        context, classWriter.getClassDoc(), writerFactory.getConstructorWriter(classWriter));
  }

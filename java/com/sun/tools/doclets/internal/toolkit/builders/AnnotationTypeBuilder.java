...
public class AnnotationTypeBuilder extends AbstractBuilder {
  ...
  private AnnotationTypeBuilder(
      Context context, AnnotationTypeDoc annotationTypeDoc, AnnotationTypeWriter writer) {
    super(context);
   ...
   * @param writer            the doclet specific writer.
   */
  public static AnnotationTypeBuilder getInstance(
      Context context, AnnotationTypeDoc annotationTypeDoc, AnnotationTypeWriter writer)
      throws Exception {
  ...
  public void buildAnnotationTypeSignature(XMLNode node, Content annotationInfoTree) {
    StringBuilder modifiers = new StringBuilder(annotationTypeDoc.modifiers() + " ");
  ...
  public void buildAnnotationTypeFieldDetails(XMLNode node, Content memberDetailsTree)
    ...
    configuration
        .getBuilderFactory()
        .getAnnotationTypeFieldsBuilder(writer)
        .buildChildren(node, memberDetailsTree);
  }
  ...
  public void buildAnnotationTypeOptionalMemberDetails(XMLNode node, Content memberDetailsTree)
    ...
    configuration
        .getBuilderFactory()
        .getAnnotationTypeOptionalMemberBuilder(writer)
        .buildChildren(node, memberDetailsTree);
  }
  ...
  public void buildAnnotationTypeRequiredMemberDetails(XMLNode node, Content memberDetailsTree)
    ...
    configuration
        .getBuilderFactory()
        .getAnnotationTypeRequiredMemberBuilder(writer)
        .buildChildren(node, memberDetailsTree);
  }
}

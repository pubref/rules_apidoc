...
public class AnnotationTypeFieldBuilder extends AbstractMemberBuilder {
   ...
   */
  protected AnnotationTypeFieldBuilder(
      Context context, ClassDoc classDoc, AnnotationTypeFieldWriter writer, int memberType) {
    super(context);
  ...
  public static AnnotationTypeFieldBuilder getInstance(
      Context context, ClassDoc classDoc, AnnotationTypeFieldWriter writer) {
    return new AnnotationTypeFieldBuilder(
        context, classDoc, writer, VisibleMemberMap.ANNOTATION_TYPE_FIELDS);
  }

...
public class MethodBuilder extends AbstractMemberBuilder {
  ...
  private MethodBuilder(Context context, ClassDoc classDoc, MethodWriter writer) {
    ...
    methods = new ArrayList<ProgramElementDoc>(visibleMemberMap.getLeafClassMembers(configuration));
   ...
   */
  public static MethodBuilder getInstance(Context context, ClassDoc classDoc, MethodWriter writer) {

...
public class Extern {
  ...
  public DocLink getExternalLink(
      String pkgName, DocPath relativepath, String filename, String memberName) {
   ...
   */
  public boolean link(
      String url, String pkglisturl, DocErrorReporter reporter, boolean linkoffline) {
    ...
    try {
      if (file.exists() && file.canRead()) {
        boolean pathIsRelative =
            !DocFile.createFileForInput(configuration, path).isAbsolute() && !isUrl(path);

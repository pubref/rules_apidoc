...
public class DocFinder {
  ...
  public static class Input {
    ...
    public Input copy() {
      ...
      if (clone.element == null) throw new NullPointerException();
      return clone;
    }
  }
  ...
  public static Output search(Input input) {
    ...
    if (input.isInheritDocTag) {
      ...
      output.inlineTags =
          input.isFirstSentence ? input.element.firstSentenceTags() : input.element.inlineTags();

...
public interface ConstantsSummaryWriter {
   ...
   */
  public abstract void addLinkToPackageContent(
      PackageDoc pkg,
   ...
   *                    be written
   */
  public abstract void addPackageName(
      PackageDoc pkg, String parsedPackageName, Content summariesTree);
   ...
   */
  public abstract void addConstantMembers(
      ClassDoc cd, List<FieldDoc> fields, Content classConstantTree);

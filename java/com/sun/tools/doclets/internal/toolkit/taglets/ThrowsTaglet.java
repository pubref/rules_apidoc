...
public class ThrowsTaglet extends BaseExecutableMemberTaglet implements InheritableTaglet {
   ...
   * documented.
   */
  private Content inheritThrowsDocumentation(
      Doc holder,
  ...
  public Content getTagletOutput(Doc holder, TagletWriter writer) {
    ...
    if (tags.length > 0) {
      result.addContent(throwsTagsOutput(execHolder.throwsTags(), writer, alreadyDocumented, true));
    }
    result.addContent(
   ...
   */
  protected Content throwsTagsOutput(
      ThrowsTag[] throwTags,
      TagletWriter writer,
      Set<String> alreadyDocumented,
      boolean allowDups) {

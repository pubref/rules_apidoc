...
public class ParamTaglet extends BaseTaglet implements InheritableTaglet {
  ...
  public void inherit(DocFinder.Input input, DocFinder.Output output) {
    ...
    ParamTag[] tags =
        input.isTypeVariableParamTag
            ? ((MethodDoc) input.element).typeParamTags()
            : ((MethodDoc) input.element).paramTags();
  ...
  private Content processParamTag(
    ...
    result.addContent(writer.paramTagOutput(paramTag, name));
    return result;
  }
}
